...
│🚨 ashishbugpc (jumlah)
│🚨 ashishbugvn (jumlah)
│🚨 ashishtroliv2 (jumlah)
│🚨 ashishliveloc (jumlah)
│🚨 ashishbuglist (jumlah)
│🚨 adhishtagwae (jumlah)
│🚨 ashishcatalog (jumlah)
│🚨 ashishbugstik (jumlah)
│🚨 ashishthelima (jumlah)
│🚨 crashcok (jumlah)
│🚨 ashishbutton (jumlah)
│🚨 ashishbugloc (jumlah)
│🚨 ashishbugdoc (jumlah)
│🚨 ashishlivelocv2 (jumlah)
│🚨 ashishbuginvite (jumlah)
│🚨 ashishbugstikv2 (jumlah)
│🚨 ashishcatalogv2 (jumlah)
│🚨 ashishbugbutton (jumlah)
│🚨 ashishbuttonbro (jumlah)
╰━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐
 ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
╭━━•›〘 ATTACK MENU 〙
│🚨 ashishsendbug1 (Nomer) 
│🚨 ashishsendbug2 (Nomer) 
│🚨 ashishsendbug3 (Nomer) 
│🚨 ashishsendbug4 (Nomer) 
│🚨 ashishsendbug5 (Nomer) 
│🚨 ashishsendbug6 (Nomer) 
│🚨 ashishsendbug7 (Nomer) 
│🚨 ashishsendbug8 (Nomer) 
│🚨 ashishsendbug9 (Nomer) 
│🚨 ashishsendbug10 (Nomer) 
│🚨 ashishsendbug11 (Nomer) 
│🚨 ashishsendbug12 (Nomer) 
│🚨 ashishvnto (Nomer) 
│🚨 ashishkintilto (Nomer)
│🚨 butto (Nomer) 
│🚨 ashishstikto (Nomer) 
│🚨 ashishtrolito (Nomer)
│🚨 ashishkontolto (Nomer)
│🚨 ashishkuntulto (Nomer)
│🚨 ashishheyto (Nomer)
│🚨 ashishsantetto (Nomer) 
│🚨 ashishmomoto (Nomer) 
│🚨 ashishbuglocto (Nomer)
│🚨 ashishinfiniteto (Nomer) 
│🚨 ashishbuttonto (Nomer)
│🚨 ashishlivelocto (Nomer)
│🚨 ashishbugdocto (Nomer)
│🚨 ashishbuginviteto (Nomer)
│🚨 ashishtengkorakto (Nomer) 
╰━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐
 ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
╭━━•› 〘 ATTACK2 MENU 〙
│🚨 ashishgasbug1 (Nomer) 
...
│🚨 ashishgasbug8 (Nomer) 
│🚨 ashishgasbug9 (Nomer) 
│🚨 ashishgasbug10 (Nomer) 
│🚨 ashishgasbug11 (Nomer) 
│🚨 ashishgasbug12 (Nomer) 
│🚨 ashishgasvn (Nomer) 
│🚨 ashishgasstik (Nomer) 
│🚨 ashishgastroli (Nomer)
│🚨 ashishgaskintil (Nomer)
│🚨 ashishgashello (Nomer) 
│🚨 ashishgaskintol (Nomer)
│🚨 ashishgaskuntul (Nomer)
│🚨 ashishgasmomo (Nomer) 
│🚨 ashishgassantet (Nomer) 
│🚨 ashishgasinfinite (Nomer) 
│🚨 ashishgasliveloc (Nomer)
│🚨 ashishgasbutton (Nomer)
│🚨 ashishgasbugloc (Nomer)
│🚨 ashishgastengkorak (Nomer) 
╰━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐
 ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
╭━━•›〘 JADIVIRUS MENU 〙
│🚨 polling (Teks)
