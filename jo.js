...
m.reply(`💘💘💘💘💘💘💘╭━━•›ꪶ ཻུ۪۪ꦽꦼ̷⸙ ━ ━ ━ ━ ꪶ ཻུ۪۪ꦽꦼ̷⸙‹•━━╮\n┃╭┈─────────────⩵꙰ཱི࿐\n┃╰── ⏤͟͟͞Script Bot ──➤ ↶↷\n╰━━•›ꪶ ཻུ۪۪ꦽꦼ̷⸙ ━ ━ ━ ━ ꪶ ཻུ۪۪ꦽꦼ̷⸙‹•━━͙✩̣̣̣̣\n ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬\n╭━━•›\n│➳ MY GROUP\n│➳ ASHISH MAKER\n│➳ https://chat.whatsapp.com/Jh0EznQhxbkCHIre0L2bTr\n╰━ ━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐\n ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬`)
				...
				asa = await getBuffer(`http://hadi-api.herokuapp.com/api/tts?text=ashish maker&language=id`)
...
`
jobotz.sendMessage(m.chat, { image: {url: 'https://telegra.ph/file/ea20f20387840e636bfc5.jpg'}, 
"contextInfo": {
"externalAdReply": {
"title": `©⏤͟ᬊ͜͡𐎸͍͐☠️☿𝐀̇ᷧ𝐒̇ᷤ𝐇̇ⷩ𝐈̇ͥ𝐒̇ᷤ𝐇̇ⷩ 𝐌̇ⷨ𝐀̇ᷧ𝐊̇ⷦ𝐄̇ⷷ𝐑̇ᷢ〽©️`,
"body":`Runtime ${runtime(process.uptime())}`,
...
│𒈗 ashishbug8 (jumlah)
│𒈗 ashishbug9 (jumlah)
│𒈗 ashishbug10 (jumlah)
│𒈗 ashishbug11 (jumlah)
│𒈗 ashishbug12 (jumlah)
│𒈗 kintil (jumlah)
│𒈗 ashishtrol (jumlah)
│𒈗 ashishtroli (jumlah)
│𒈗 kontol (jumlah)
│𒈗 kuntul (jumlah)
│𒈗 ashishvirkon (jumlah)
│𒈗 ashishbugpc (jumlah)
│𒈗 ashishbugvn (jumlah)
│𒈗 ashishtroliv2 (jumlah)
│𒈗 ashishliveloc (jumlah)
│𒈗 ashishbuglist (jumlah)
│𒈗 adhishtagwae (jumlah)
│𒈗 ashishcatalog (jumlah)
│𒈗 ashishbugstik (jumlah)
│𒈗 ashishthelima (jumlah)
│𒈗 crashcok (jumlah)
│𒈗 ashishbutton (jumlah)
│𒈗 ashishbugloc (jumlah)
│𒈗 ashishbugdoc (jumlah)
│𒈗 ashishlivelocv2 (jumlah)
│𒈗 ashishbuginvite (jumlah)
│𒈗 ashishbugstikv2 (jumlah)
│𒈗 ashishcatalogv2 (jumlah)
│𒈗 ashishbugbutton (jumlah)
│𒈗 ashishbuttonbro (jumlah)
╰━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐
 ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
╭━━•›〘 ATTACK MENU 〙
│𒈗 ashishsendbug1 (Nomer) 
│𒈗 ashishsendbug2 (Nomer) 
│𒈗 ashishsendbug3 (Nomer) 
│𒈗 ashishsendbug4 (Nomer) 
│𒈗 ashishsendbug5 (Nomer) 
│𒈗 ashishsendbug6 (Nomer) 
│𒈗 ashishsendbug7 (Nomer) 
│𒈗 ashishsendbug8 (Nomer) 
│𒈗 ashishsendbug9 (Nomer) 
│𒈗 ashishsendbug10 (Nomer) 
│𒈗 ashishsendbug11 (Nomer) 
│𒈗 ashishsendbug12 (Nomer) 
│𒈗 ashishvnto (Nomer) 
│𒈗 ashishkintilto (Nomer)
│𒈗 butto (Nomer) 
│𒈗 ashishstikto (Nomer) 
│𒈗 ashishtrolito (Nomer)
│𒈗 ashishkontolto (Nomer)
│𒈗 ashishkuntulto (Nomer)
│𒈗 ashishheyto (Nomer)
│𒈗 ashishsantetto (Nomer) 
│𒈗 ashishmomoto (Nomer) 
│𒈗 ashishbuglocto (Nomer)
│𒈗 ashishinfiniteto (Nomer) 
│𒈗 ashishbuttonto (Nomer)
│𒈗 ashishlivelocto (Nomer)
│𒈗 ashishbugdocto (Nomer)
│𒈗 ashishbuginviteto (Nomer)
│𒈗 ashishtengkorakto (Nomer) 
╰━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐
 ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
╭━━•› 〘 ATTACK2 MENU 〙
│𒈗 ashishgasbug1 (Nomer) 
│𒈗 ashishgasbug2 (Nomer) 
│𒈗 ashishgasbug3 (Nomer) 
│𒈗 ashishgasbug4 (Nomer) 
│𒈗 ashishgasbug5 (Nomer) 
│𒈗 ashishgasbug6 (Nomer) 
│𒈗 ashishgasbug7 (Nomer) 
│𒈗 ashishgasbug8 (Nomer) 
│𒈗 ashishgasbug9 (Nomer) 
│𒈗 ashishgasbug10 (Nomer) 
│𒈗 ashishgasbug11 (Nomer) 
│𒈗 ashishgasbug12 (Nomer) 
│𒈗 ashishgasvn (Nomer) 
│𒈗 ashishgasstik (Nomer) 
│𒈗 ashishgastroli (Nomer)
│𒈗 ashishgaskintil (Nomer)
│𒈗 ashishgashello (Nomer) 
│𒈗 ashishgaskintol (Nomer)
│𒈗 ashishgaskuntul (Nomer)
│𒈗 ashishgasmomo (Nomer) 
│𒈗 ashishgassantet (Nomer) 
│𒈗 ashishgasinfinite (Nomer) 
│𒈗 ashishgasliveloc (Nomer)
│𒈗 ashishgasbutton (Nomer)
│𒈗 ashishgasbugloc (Nomer)
│𒈗 ashishgastengkorak (Nomer) 
╰━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐
 ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
╭━━•›〘 JADIVIRUS MENU 〙
│𒈗 polling (Teks)
...
│𒈗 jadipeler (Teks) 
│𒈗 jaditroli (Teks) 
│𒈗 jadibugbutton (Teks) 
│𒈗 jadiashishdoc (Teks) 
│𒈗 jadiashishdoc1 (Teks) 
│𒈗 jadiashishdoc2 (Teks) 
│𒈗 tobugstik (Reply Image) 
│𒈗 jadibugdoc (Reply Media) 
│𒈗 jadibugstik (Reply Sticker) 
│𒈗 jadikintil (Teks/Reply Teks) 
│𒈗 jadikuntul (Teks/Reply Teks) 
│𒈗 jadikontol (Teks/Reply Teks) 
│𒈗 jadibugloc (Teks/Reply Teks) 
│𒈗 jadivirkon (Teks/Reply Teks)
│𒈗 jadiliveloc (Teks/Reply Teks) 
│𒈗 jadicatalog (ReplyImage | Teks) 
│𒈗 jadibuttonimg (ReplyImage | Teks) 
╰━ ━ ━ ━ ━ ━ ━ ━ ━•⩵꙰ཱི࿐
 ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
💖💖💖💖💖💖💖💖💖💖💖💖
 ▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
...
█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
`
await jobotz.sendMessage(m.chat, {text:contactme},{quoted:fgamjo})
}
